...
class FakeDB:
    ...
    def get_sheep(self, id: int) -> Sheep | None:
    ...
    def update_sheep(self, id: int, updated: Sheep) -> Sheep:
        if id not in self.data:
            raise ValueError("Sheep not found")
        self.data[id] = updated
        return updated
...
db.data = {
    ...
    3: Sheep(id=3, name="Dedee", breed="Jacobs Four Horns", sex="ram"),
